"""Regression checks for the silver-ui-editor-line casebook."""
...
from casebook.harness import assert_expected, silver_ui_editor_line_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(silver_ui_editor_line_summary(), assert_expected())
